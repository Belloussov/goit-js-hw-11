import{S as d,i as a}from"./assets/vendor-7659544d.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function s(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(e){if(e.ep)return;e.ep=!0;const t=s(e);fetch(e.href,t)}})();function m(o){const r="https://pixabay.com",s="/api/",i=new URLSearchParams({key:"42985160-4d9b5f931f1b68b881db47de1",q:o,image_type:"photo",orientation:"horizontal",safesearch:!0}),e=`${r}${s}?${i}`;return fetch(e).then(t=>{if(!t.ok)throw new Error(response.status);return t.json()})}function f(o){return o.map(r=>`<li class="gallery-item">
    ...
    </li>`).join("")}const l=document.querySelector(".form"),h=document.querySelector(".gallery");let c=new d(".gallery a",{captionsData:"alt",captionDelay:250});c.on("show.simplelightbox",function(){});const u=document.querySelector(".loader");function p(){return u.classList.remove("is-hidden")}function g(){return u.classList.add("is-hidden")}l.addEventListener("submit",o=>{o.preventDefault();const r=o.target.elements.search.value.trim();if(r==="")return a.warning({message:"Please complete the field!",color:"red",position:"topRight"});p(),m(r).then(s=>{const i=f(s.hits);s.hits.length===0?a.error({message:"Sorry, there are no images matching your search query. Please try again!",position:"topRight",color:"red"}):(h.insertAdjacentHTML("beforeend",i),c.refresh())}).catch(s=>{a.error({message:"Sorry, there are no images matching your search query. Please try again!",position:"topRight",color:"red"})}).finally(()=>{g(),l.reset()})});
